...
library(SeuratDisk)
# variables
WD <- "/w5home/bmoore/scRNAseq/LiFangChu/fluidigm_gup_expr_results/output_20240417_134352/"
SEURAT_OBJ <- "clustered_seurat_obj.rds"
METADATA_GAMM <- "NA" #"/w5home/bmoore/Gamm_scRNAseq/data/gamm_metadata/gammS2_manual_annot_metadata_c0.5.txt"
OUTPUT_name <- "clustered_seurat_obj.h5Seurat"
